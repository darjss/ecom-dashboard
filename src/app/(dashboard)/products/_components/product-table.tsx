...
import { ChevronLeft, ChevronRight, Search, PlusCircle, Database } from "lucide-react"
      ...
      <CardContent className="space-y-6 p-2 sm:p-6">
        ...
        <div className="flex flex-col items-center gap-4 px-2 sm:flex-row sm:justify-between sm:px-0">
          <p className="text-center text-xs text-muted-foreground sm:text-left sm:text-sm">
            Showing {(page - 1) * PRODUCT_PER_PAGE + 1} to {Math.min(page * PRODUCT_PER_PAGE, totalProducts)} of{" "}
