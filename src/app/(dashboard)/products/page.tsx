...
import { paginated } from "@/server/actions/product"
...
const Page = async ({
  ...
  const paginatedResult = await paginated(Number.parseInt(page), PRODUCT_PER_PAGE)
  ...
  return (
    <Suspense fallback={<DataTableSkeleton columnCount={6} rowCount={3} />}>
      <ProductGrid
        ...
        initialTotalProduct={paginatedResult.totalCount ?? 0}
        brands={brands}
